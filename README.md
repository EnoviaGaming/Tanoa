...
[![Tanoa Life Version](https://img.shields.io/badge/version-v0.1-green.svg)](https://github.com/ArmaLife/Tanoa)
&nbsp;&nbsp;&nbsp;
[![Tanoa Life Release](https://img.shields.io/badge/release-1-yellowgreen.svg)](https://github.com/ArmaLife/Tanoa/releases)
&nbsp;&nbsp;&nbsp;
[![Arma 3 Version](https://img.shields.io/badge/arma%203-1.54-orange.svg)](http://dev.arma3.com/post/spotrep-00051)
&nbsp;&nbsp;&nbsp;
[![Join the chat at https://gitter.im/ArmaLife/Tanoa](https://badges.gitter.im/ArmaLife/Tanoa.svg)](https://gitter.im/ArmaLife/Tanoa?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
</br>
<b>Tanoa Life</b> or <b>[Tanoa Life RPG] (http://www.altisliferpg.com)</b> is based on [Altis Life](https://github.com/ArmaLife/Altis), which is developed by <b>Tonic</b> AKA <b>[TAW_Tonic] (https://github.com/TAWTonic)</b>.<br/>
This contains primarily the release contain and on-going development changes to the mission.<br/>
Tanoa Life RPG by Tonic is licensed under a [Creative Commons Attribution-NonCommercial-NoDerivs 3.0 Unported License] (http://creativecommons.org/licenses/by-nc-nd/3.0/deed.en_US)
<br/>
...
------
>   The branding of the mission is to stay Tanoa Life RPG’. This means you cannot modify it to say something else. i.e Tanoa Life by YOURCOMMUNITYNAME/TAG. Everything about the naming / branding is to be left untouched.
...
>   All of my code is not to be used outside of the mission in another ‘Life’ like mission. It is to stay the ArmaLife RPG Framework / my framework or you don’t use it and direct branding.
...
>   ArmaLife RPG Framework is only allowed to be used with the Arma 3 vanilla maps with no extensions or mods (with the exception of server sided mods, and direct permission from author).
...
>   Features added by you to the mission are to stay to your modification in your server, distribution is not allowed without my permission, if you would like your feature to be added to the Tanoa Life RPG main distribution (by me) you can submit your changes and will be fully credited.
